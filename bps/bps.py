...
def _encode_single_thread(x, bps_arrangement='random', n_bps_points=512, radius=1.5, bps_cell_type='dists',
                          verbose=1, random_seed=13, x_features=None, custom_basis=None):
    """Converts point clouds to basis point set (BPS) representation (SINGLE THREAD)
